/*
Script Purpose:
This Data Definition Language (DDL) script creates a set of staging tables in the 'silver' schema 
based on the structure and content of the bronze layer. It performs a full load, first
it truncate sthe tables and then it creates them.

Adds an extra column for the metadata in each table, keep the creation date for each record.
*/
